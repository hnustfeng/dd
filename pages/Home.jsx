    ...
    return (
        <div  >
            ...
            <div className='box-border md:h-[48rem] bg-[#FFFFFF] md:py-[6.4rem] md:px-[8rem]'>
                ...
                <div className='md:flex md:justify-between box-border px-[16px] py-[32px] md:py-0 md:px-[3.2rem]'>
                    ...
                    <div className=' text-center mt-[0px] md:mt-[0px]'>
                        ...
                        <div className='mt-[2rem] mb-[1.2rem] text-[20px] md:text-[2.2rem] font-semibold'>Scroll</div>
            ...
            {/* <div className='box-border h-[328px] py-[64px] px-[80px] text-center' >
                <div className='font-bold text-[24px] md:text-[3.2rem]'>Our Partners</div>
                <div className='mt-[12px] md:mt-[1.6rem] text-[16px] md:text-[1.8rem]'>Supported by excellent partners in the Web3 space, Meow is growing stronger </div>
                <div className='mt-[12px] md:mt-[1.6rem] text-[16px] md:text-[1.8rem] mb-[32px] md:mb-[3.2rem]'>with their help.</div>
