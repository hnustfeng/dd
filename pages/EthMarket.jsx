                    ...
                    assetRow.push(
                        {
                            ...
                            miningDPR:BigNumber.from(marketdata[index]["TotalBorrowed"]).add(BigNumber.from(marketdata[index]['TotalSupplied'])).isZero()?(0).toFixed(2):(29166700/(BigNumber.from(marketdata[index]["TotalBorrowed"]).add(BigNumber.from(marketdata[index]['TotalSupplied']))).toNumber()*3/7).toFixed(2),
                        }
                    )
                } else {
                    assetRow.push(
            ...
            <div className='box-border  py-[64px] px-[32px] md:px-[11.2rem] rounded-[1rem]'>
                ...
                {loading ? <Skeleton className='hidden md:block' loading={loading} active></Skeleton> :
                    <div className='hidden md:block w-[100%] mt-[64px] rounded-[1px] border border-solid border-[#b0b6bd] font-bold ' >
                        <div className='mt-[2rem] ml-[2rem] text-[2.4rem] ml-[1rem]'>Ethereum assets</div>
                    ...
                    <div className='md:hidden  px-[32px] py-[32px]  mt-[64px] rounded-[1px] border border-solid border-[#b0b6bd] font-bold ' >
                        ...
                        {data && data.map((item, index) => (<div>
                            <div className='flex mb-[16px]'>
                                ...
                                <div>
                                    <div className='leading-[24px] text-[16px] text-[#5F6D7E]'>Asset</div>
